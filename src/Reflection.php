...
final class Reflection
{
	...
	private static function getType($reflection, ?ReflectionType $type, bool $asArray = false)
	{
		if ($type === null) {
			...
			throw new RuntimeException('The ' . self::toString($reflection) . ' is not expected to have a union type.');

		} else {
			throw new RuntimeException('Unexpected type of ' . self::toString($reflection));
		}
	}
